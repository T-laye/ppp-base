...
export function poc_validate(values) {
  ...
  //   errors.allocation = "Required";
  // }
  // if (!values.unit) {
  //   errors.unit = "Required";
  // }

  // if (!values.product_name || values.product_name === "Select product") {
...
export function edit_email_validate(values) {
  const errors = {};

  if (!values.email_template) {
    errors.email_template = "Required";
  }
  if (!values.subject) {
