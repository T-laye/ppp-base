...
export default function PocList({ name, available, total }) {
  ...
  return (
    <Link href="/admin/poc/id">
      <li className="rounded-xl border px-4 pt-1 pb-4 border-gray-200 bg-red-30 hover:text-white hover:border-primaryActive active:bg-primaryActive duration-200 mt-4">
